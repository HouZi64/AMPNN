...
from models.network.LSTM_resnet_Attention1_FPN3 import model_mz
...
# print("X test shape: {} \t X train shape: {}".format(X_raw_test.shape, X_raw_train.shape))
# print("y test shape: {} \t\t y train shape: {}".format(y_raw_test.shape, y_raw_train.shape))
